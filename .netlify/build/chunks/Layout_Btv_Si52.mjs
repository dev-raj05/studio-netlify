...
const title = "Marketing Attribution & Analytics Insights | BooleanMaths Blog";
const description = "Stay ahead with expert insights on marketing attribution, customer journey analytics, and conversion tracking. Explore the latest trends and strategies to optimize your campaigns with BooleanMaths Blog.";
...
}, "C:/Users/User/OneDrive/Desktop/test/working-venv-astro/node_modules/astro-icon/components/Icon.astro", void 0);
...
}, "C:/Users/User/OneDrive/Desktop/test/working-venv-astro/src/components/Footer.astro", void 0);
...
Book Demo
                    ...
                    ">
Book Demo
</button> </a> </div> </div> </nav> ${renderScript($$result, "C:/Users/User/OneDrive/Desktop/test/working-venv-astro/src/components/Navbar2.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/User/OneDrive/Desktop/test/working-venv-astro/src/components/Navbar2.astro", void 0);
...
}, "C:/Users/User/OneDrive/Desktop/test/working-venv-astro/src/components/Cta.astro", void 0);
...
function jsonLDGenerator({
  ...
  if (type === "post" && post) {
    const ldData = {
      ...
      image: post.image ? post.image.src : void 0,
      author: {
        "@type": "Person",
        name: post.author,
...
const $$Seo = createComponent(($$result, $$props, $$slots) => {
  ...
  const jsonLD = jsonLDGenerator({
    type: isPost ? "post" : "website",
    post: frontmatter,
    url
  });
  const imageSrc = image?.src || siteData.image.src;
  const imageAlt = image?.alt || siteData.image.alt;
  const ogType = isPost ? "article" : "website";
  return renderTemplate`<!-- Title & Meta Description --><title>${title}</title><meta name="description"${addAttribute(description, "content")}><!-- Canonical URL --><link rel="canonical"${addAttribute(url, "href")}><!-- Open Graph Meta Tags --><meta property="og:site_name" content="Booleanmaths Blog"><meta property="og:type"${addAttribute(ogType, "content")}><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:url"${addAttribute(url, "content")}><meta property="og:image"${addAttribute(imageSrc, "content")}><meta property="og:image:url"${addAttribute(imageSrc, "content")}><meta property="og:image:secure_url"${addAttribute(imageSrc, "content")}><meta property="og:image:type" content="image/jpeg"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="600"><meta property="og:image:alt"${addAttribute(imageAlt, "content")}><meta property="og:locale" content="en_US"><!-- Twitter Meta Tags --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(title, "content")}><meta name="twitter:description"${addAttribute(description, "content")}><meta name="twitter:image"${addAttribute(imageSrc, "content")}><meta name="twitter:image:alt"${addAttribute(imageAlt, "content")}><meta name="twitter:site" content="@Booleanmaths"><meta name="twitter:domain"${addAttribute("https://yoursite.netlify.app", "content")}><!-- Optional Robots Meta Tag -->${robots && renderTemplate`<meta name="robots"${addAttribute(robots, "content")}>`}<!-- Inject the JSON‑LD script -->${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(jsonLD)}` })}`;
}, "C:/Users/User/OneDrive/Desktop/test/working-venv-astro/src/components/Seo.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  const title = providedTitle || siteData.title;
  const description = providedDescription || siteData.description;
  const image = providedImage || siteData.image;
  const visualEditingEnabled = true;
  return renderTemplate`<html lang="en" data-astro-cid-sckkx6r4> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="icon" type="image/svg+xml" href="/favicon.ico"><meta name="generator"${addAttribute(Astro2.generator, "content")}><!-- Title & Meta Description --><title>${title}</title><meta name="description"${addAttribute(description, "content")}><!-- SEO Component (includes JSON‑LD, Open Graph, Twitter tags, etc.) -->${renderComponent($$result, "Seo", $$Seo, { "title": title, "description": description, "url": Astro2.url, "image": image, "frontmatter": frontmatter, "robots": robots, "data-astro-cid-sckkx6r4": true })}<!-- Canonical URL --><link rel="canonical"${addAttribute(Astro2.url, "href")}><!-- Styles and Fonts --><link rel="stylesheet" href="/styles.css"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet"><link rel="sitemap" href="/sitemap-index.xml">${renderHead()}</head> <body class="flex flex-col" data-astro-cid-sckkx6r4> <div data-astro-cid-sckkx6r4> ${renderComponent($$result, "Navbar2", $$Navbar2, { "data-astro-cid-sckkx6r4": true })} <div class="flex flex-col min-h-screen mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 container" data-astro-cid-sckkx6r4> <main class="flex-grow sm:px-6 lg:px-8" data-astro-cid-sckkx6r4> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "VisualEditing", $$VisualEditing, { "enabled": visualEditingEnabled, "zIndex": 1e3, "data-astro-cid-sckkx6r4": true })} </main> </div> ${renderComponent($$result, "Cta", $$Cta, { "data-astro-cid-sckkx6r4": true })} ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-sckkx6r4": true })} </div> </body></html>`;
}, "C:/Users/User/OneDrive/Desktop/test/working-venv-astro/src/layouts/Layout.astro", void 0);
